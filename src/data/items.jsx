...
const itemGroups = {
 ...
 T2: {
  ...
  Resources: {
    ...
    "Coral": [
      { name: 'Coral Chunk', image: '/images/resources/coral/crafting-coral-chunk-icon.png', duration: 3600 }, //1hr
      ...
      { name: 'Coral Hypercube', image: '/images/resources/coral/crafting-coral-cube-hyper-icon.png', duration: 57600 }, //16hr
      { name: 'Hypercube of the Sea', image: '/images/resources/coral/crafting-sea-cube-hyper-icon.png', duration: 86400 } //24hr
    ],
    "Salt": [
      { name: 'Salt  Clump', image: '/images/resources/salt/crafting-salt-chunk-icon.png', duration: 3600 }, //1hr
      ...
      { name: 'Salt Hypercube', image: '/images/resources/salt/crafting-salt-cube-hyper-icon.png', duration: 57600 }, //16hr
      { name: 'Hypercube of the Sea', image: '/images/resources/salt/crafting-sea-cube-hyper-icon.png', duration: 86400 } //24hr
    ],
    "Marble": [
